...
<div class=" wrapper-content"style="height:75.5%;background-color: #FFFFFF" >
        ...
        <div class="col-xs-12" style="background-color: #ffffff;padding-right: 0px;">
                ...
                <div class="col-md-8" style="padding: 0px">
                    <h3  style="color:#767676"><i class="fa fa-bars" style="color:#767676"></i>&nbsp;&nbsp;车辆放行记录</h3>
                </div>
                <div class="col-md-4">
        ...
        <div class="col-xs-12" style="margin-top: 0px;background-color:#ffffff;border-top: solid 2px #EFEFEF;">
            ...
            <div class="col-xs-12" style="margin-top: 0px;background-color:#ffffff;">
                <table class="table table-striped table-bordered table-hover dataTables-example" id="releaseDetails" style="background-color:#ffffff ">
                    <thead>
...
<script src="${pageContext.request.contextPath}/resources/script/admin/releaseDetails.js"></script>
