...
<div class=" wrapper-content"style="height:100%;background-color: #FFFFFF" >
    <%--<div class="col-xs-12" style="padding-bottom: 10px">
        <h3  style="color:#767676;"><i class="fa fa-bars" style="color:#767676"></i>&nbsp;&nbsp;收费类型统计分析</h3>
    </div>--%>
    <div class="col-xs-12 ">
        <div class="col-sm-3">
            <div class="input-group m-b">
                <span class="input-group-addon input-group-background">收费类型</span>
                <select class="form-control m-b" data-placeholder="选择收费类型..." name="chargeTypeSearch" id="chargeTypeSearch">
                </select>
            </div>
        </div>
    ...
    <div class="col-xs-12" style="padding-top:0px;border-bottom: solid 1px #EFEFEF">
        <div class="col-sm-1">
            <div class="input-group m-b">
                <a href="javascript:void(0)" type="button" class="btn btn-success btn-success2"  data-toggle="modal" onclick="searchChargeType()"><i class="fa fa-search"></i>&nbsp;&nbsp;搜索</a>
            </div>
        </div>

        <div class="col-sm-1">
            <div class="input-group m-b">
                <a href="javascript:void(0)" type="button" class="btn btn-success " data-toggle="modal" onclick="outChargeTypeExcel()">导出报表</a>
            </div>
        </div>
    </div>
    <div class="col-xs-12" style="margin-top: 20px;background-color:#ffffff;">
        <table class="table table-striped table-bordered table-hover dataTables-example " id="chargeType">
            <thead>
            <tr style="color: #767676;">
            <tr ><td rowspan=2>收费类型</td><td rowspan=2>时间</td><td rowspan=2>收费次数</td><td colspan=4 style="background-color:#ffffff ">应收金额</td><td colspan=4 style="background-color:#ffffff ">实收金额</td></tr>
...
<script src="${pageContext.request.contextPath}/resources/script/admin/chargeType.js"></script>
