...
<div class=" wrapper-content"style="height:100%;background-color: #FFFFFF" >
        ...
        <div class="col-xs-12" style="background-color: #ffffff;padding-right: 0px;">
            ...
            <%--<h3  style="color:#767676"><i class="fa fa-bars" style="color:#767676"></i>&nbsp;&nbsp;车辆进出明细</h3>--%>
            </div>
            <div class="col-md-3">
        ...
        <div class="col-xs-12" style="margin-top: 0px;background-color:#ffffff;border-top: solid 2px #EFEFEF;">
            ...
            <div class="col-xs-12" style="margin-top: 0px;background-color:#ffffff;">
                <table class="table table-striped table-bordered table-hover dataTables-example" id="entryDetails" style="background-color:#ffffff ">
                    <thead>
...
<script src="${pageContext.request.contextPath}/resources/script/admin/entryDetails.js"></script>
