...
<div class=" wrapper-content"style="height:100%;background-color: #FFFFFF" >
        ...
        <div class="col-xs-12" style="background-color: #ffffff;padding-right: 0px;">
            ...
            <%--<h3  style="color:#767676"><i class="fa fa-bars" style="color:#767676"></i>&nbsp;&nbsp;操作日志明细</h3>--%>
            </div>

            <div class="col-md-4">
                <div class="input-group m-b">
                    <span class="input-group-addon"><i class="fa fa-book"></i>&nbsp;&nbsp;日志类型名称</span>
                    <input type="text" id="logName" placeholder="查询" class="form-control">
        ...
        <div class="col-xs-12" style="margin-top: 0px;background-color:#ffffff;border-top: solid 2px #EFEFEF;">
            ...
            <div class="col-xs-12" style="margin-top: 0px;background-color:#ffffff;">
                <table class="table table-striped table-bordered table-hover dataTables-example" id="logDetails" style="background-color:#ffffff ">
                    <thead>
...
<script src="${pageContext.request.contextPath}/resources/script/admin/logDetails.js"></script>
