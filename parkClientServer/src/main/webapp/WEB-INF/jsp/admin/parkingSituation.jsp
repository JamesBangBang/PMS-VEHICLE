...
<div class=" wrapper-content"style="height:100%;background-color: #FFFFFF" >
    ...
    <div class="col-xs-12" style="padding-top:0px;border-bottom: solid 1px #EFEFEF">
        <div class="col-sm-1">
            <div class="input-group m-b">
                <a href="javascript:void(0)" type="button" class="btn btn-success btn-success2"  data-toggle="modal" onclick="searchParkingSituation()"><i class="fa fa-search"></i>&nbsp;&nbsp;搜索</a>
            </div>
        </div>

        <div class="col-sm-1">
            <div class="input-group m-b">
                <a href="javascript:void(0)" type="button" class="btn btn-success " data-toggle="modal" onclick="exportParkingSituation()">导出报表</a>
            </div>
        </div>
    </div>
    <div class="col-xs-12" style="margin-top: 20px;background-color:#ffffff;">
        <table class="table table-striped table-bordered table-hover dataTables-example " id="parkingSituation">
            <thead>
            <tr style="color: #767676;">
            <tr ><td rowspan=2>时间</td><td colspan=3 style="background-color:#ffffff ">车辆进出</td><td colspan=4 style="background-color:#ffffff ">停车时长</td></tr>
...
<script src="${pageContext.request.contextPath}/resources/script/admin/parkingSituation.js"></script>
