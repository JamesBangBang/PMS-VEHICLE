...
function iniDataTable(){
    mainTable = $('#boothCharge').DataTable( {
        ordering: false,
        processing:true,
        searching:false,
        sScrollY:"300px",
        ...
        paging:true,
        ajax: {
            url: starnetContextPath + "/report/getBoothChargeReport",
            type: 'POST',
            data:{
                "beginTime":"",
                "endTime": "",
...
function exportBoothCharge() {
    var boothId = $("#boothIdSearch").val();
    if (boothId == "all") boothId = "";
    location.href = starnetContextPath + "/report/getBoothChargeExcel?sheetName=岗亭收费情况分析表&beginTime="
