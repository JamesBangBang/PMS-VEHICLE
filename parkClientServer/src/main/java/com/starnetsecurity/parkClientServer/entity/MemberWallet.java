 ...
 */
@Entity
@Table(name = "member_wallet", schema = "vams", catalog = "")
public class MemberWallet {
    ...
    public boolean equals(Object o) {
        ...
        if (driverTelephoneNumber != null ? !driverTelephoneNumber.equals(that.driverTelephoneNumber) : that.driverTelephoneNumber != null) return false;
