 ...
 */
@Entity
@Table(name = "member_kind", schema = "vams", catalog = "")
public class MemberKind {
    ...
    @ManyToOne(targetEntity = CarparkInfo.class, fetch = FetchType.LAZY)
    ...
    @OneToMany(mappedBy = "memberKind",fetch = FetchType.LAZY)
