 ...
 */
@Entity
@Table(name = "carpark_info", schema = "vams", catalog = "")
public class CarparkInfo {
    ...
    private Set<MemberKind> memberKinds;
...
//    }
    ...
    @ManyToOne(targetEntity = DepartmentInfo.class, fetch = FetchType.LAZY)
    ...
    @OneToMany(mappedBy = "carparkInfo",fetch = FetchType.LAZY)
    public Set<MemberKind> getMemberKinds() {
        return memberKinds;
    }

    public void setMemberKinds(Set<MemberKind> memberKinds) {
